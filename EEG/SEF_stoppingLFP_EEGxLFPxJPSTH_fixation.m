...
parfor sessionIdx = 1:29
    ...
    eegName = ['betaBurst\eeg_session' int2str(session) '_' FileNames{session} '_betaOutput_fixate'];
    ...
    for lfpidx = 1:length(sessionLFP)
        ...
        lfpName = ['betaBurst\fixate\lfp_session' int2str(session) '_' sessionLFPmap.channelNames{lfp} '_betaOutput_fixate'];
