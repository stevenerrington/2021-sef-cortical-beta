function burstTiming = SEF_stoppingLFP_function_getBurst_ssrt(lfpList,...
...
parfor lfpIdx = 1:length(lfpList)
    ...
    timeThreshold = [bayesianSSRT.ssrt_mean(session)+100 bayesianSSRT.ssrt_mean(session)+300];
