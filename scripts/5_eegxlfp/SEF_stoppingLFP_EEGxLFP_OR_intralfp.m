...
if ~exist('lfpxlfp_fisher_crosstab.mat')
    ...
    save('D:\projects\2021-sef-cortical-beta\data\eeg_lfp\lfpxlfp_fisher_crosstab.mat','fisherstats','crosstab_lfpi_lfpj')
else
    load('D:\projects\2021-sef-cortical-beta\data\eeg_lfp\lfpxlfp_fisher_crosstab.mat', 'fisherstats')
end
